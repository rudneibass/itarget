...
$formFieldEntityPath = '/form-field';
...
Route::get($formFieldEntityPath.'/form/create', 'App\Modules\\'.$modulePath.'\Infra\Controllers\\'.$formFieldEntity.'Get'.$formFieldEntity.'CreateController@handle');
Route::get($formFieldEntityPath.'/form/edit', 'App\Modules\\'.$modulePath.'\Infra\Controllers\\'.$formFieldEntity.'Get'.$formFieldEntity.'EditController@handle');