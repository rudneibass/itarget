...
Route::get($registrationPath.'/form/create', 'App\Modules'.$eventModulePath.'\Infra\Controllers'.$registrationEntityPath.'\Get'.$registrationEntityName.'FormController@handle');
Route::get($registrationPath.'/form/edit', 'App\Modules'.$eventModulePath.'\Infra\Controllers'.$registrationEntityPath.'\Get'.$registrationEntityName.'EditFormController@handle');
