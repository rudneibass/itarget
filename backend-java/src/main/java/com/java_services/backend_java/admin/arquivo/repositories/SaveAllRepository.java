...
@Transactional
public class SaveAllRepository {

    @Autowired
    private JdbcTemplate jdbcTemplate;

    public List<Long> handle(List<Arquivo> arquivos) {
        ...
        for (Arquivo arquivo : arquivos) {
                ...
                PreparedStatement ps = con.prepareStatement(
                    """
                        INSERT INTO arquivos (
                            tabela_pai, id_tabela_pai, nome, tipo, tamanho,
            ...
            if (key != null) {
                ...
                throw new RuntimeException("Falha ao obter o ID gerado para o arquivo: " + arquivo.getNome());
            }
        }
